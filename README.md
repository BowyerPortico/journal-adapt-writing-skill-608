...
```bash
git clone https://github.com/BowyerPortico/journal-adapt-writing-skill-608.git
cd journal-adapt-writing-skill-608
python setup.py
```
...
|---------------|-----------------|--------|
| Economics writing | Economics writing and referee-style guidance | [hanlulong/econ-writing-skill](https://github.com/BowyerPortico/journal-adapt-writing-skill-608) |
...
<!-- Last updated: 2026-06-06 18:40:35 -->
